...
То есть здесь выбираются товары, которых на складе больше 2 и у которых одновременно цена больше `30000`, либо те товары, производителем которых является `Samsung`.
