...
### Задание 20. Сохраните при объединении все, в том числе повторяющиеся строки с помощью оператора ALL:
...
### Задание 21.  Произведите сортировку по FullName (FirstName + LastName)
...
### Задание 22. В зависимости от суммы на счете клиента начислите ему определенные проценты:
...
### Задание 22. Найти всех клиентов банка, которые не являются его сотрудниками:
...
### Задание 23. Получить всех сотрудников банка, которые не являются его клиентами:
...
```
### Задание 24. Найди всех сотрудников банка, которые одновременно являются его клиентами.
